...
(function(mod) {
  ...
  CodeMirror.defineMode("stylus", function(config) {
    ...
    var tokenBase = function(stream, state) {
      ...
      // & Parent Reference or / Root Reference
      if (stream.match(/^(&|\/)(:|\.|#|[a-z])/)) {
        stream.backUp(1);
        return "variable-3";
      }
