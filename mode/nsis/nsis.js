...
CodeMirror.defineSimpleMode("nsis",{
  start:[
    ...
    {regex: /(?:\!(else|if|ifdef|ifmacrodef|ifmacrondef|ifndef|macro))\b/, token: "keyword", indent: true},
    {regex: /(?:\!(endif|macroend))\b/, token: "keyword", dedent: true},
    // Runtime Commands
    ...
    {regex: /\b(?:Function|PageEx|Section|SectionGroup)\b/, token: "keyword", indent: true},
    {regex: /\b(?:FunctionEnd|PageExEnd|SectionEnd|SectionGroupEnd)\b/, token: "keyword", dedent: true},
    // Options
    ...
    // {regex: /\$\{(?:And|Else|Or)?(?:If(Cmd|Not|Then)?|Unless)\}/, token: "variable-2", indent: true},
