/**
 * Attempting to add in Smarty 3 support. Changes:
 * - { and } auto-escapement when surrounded by whitespace
 * - ???
 *
 * Fix scenarios:
 * 		{$result = {math equation="x + y" x=5 y=10}}
 * 		{math equation="x + y" x=5 y=10}
 * See: https://github.com/marijnh/CodeMirror/issues/956
 */
CodeMirror.defineMode("smarty", function(config) {
	...
	var smartyVersion = (typeof config.mode.smartyVersion != 'undefined') ? config.mode.smartyVersion : 3;
