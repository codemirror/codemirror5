$(document).ready(function(){
  ...
  test("testProcessingInstructions", function() {
    ...
    var expected = '<span class="cm-variable cm-xquery-function">data</span>(<span class="cm-comment cm-xquery-pi">&lt;?target content?&gt;</span>) <span class="cm-keyword">instance</span> <span class="cm-keyword">of</span> <span class="cm-atom">xs:string</span>';
