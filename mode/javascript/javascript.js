CodeMirror.defineMode("javascript", function (config, parserConfig)
{
  ...
  {
    var nonBreakableRegexes = new Array();
    nonBreakableRegexes[0] = new RegExp("for\\s*?\\(([\\s\\S]*?)\\)");
    nonBreakableRegexes[1] = new RegExp("'([\\s\\S]*?)('|$)");
    nonBreakableRegexes[2] = new RegExp("\"([\\s\\S]*?)(\"|$)");
  ...
  return {
    ...
    autoFormatLineBreaks: function (text)
    {
      ...
      var nonBreakableBlocks = getNonBreakableBlocks(text);
...
CodeMirror.defineMIME("text/javascript", "javscript");
