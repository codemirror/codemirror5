...
(function() {
  ...
  var valueKeywords = keySet([
    ...
    "arabic-indic", "armenian", "asterisks", "auto", "avoid", "avoid-column",
    "avoid-page", "avoid-region", "background",
    ...
    "outside-shape", "overlay", "overline", "padding", "padding-box", "page",
    "painted", "paused", "persian", "plus-darker", "plus-lighter", "pointer",
    "portrait", "pre", "pre-line", "pre-wrap", "preserve-3d", "progress", "push-button",
    "radio", "read-only", "read-write", "read-write-plaintext-only", "region",
