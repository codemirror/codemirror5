...
var kKeywords = [
    ...
    // SIMD.
    "v128\.(load|store|const|not|andnot|and|or|xor|bitselect)",
    "i(8x16|16x8|32x4|64x2)\\.(shl|shr_[su])",
    "i(8x16|16x8)\\.(extract_lane_[su]|((add|sub)_saturate_[su])|avgr_u)",
    "(i(8x16|16x8|32x4|64x2)|f(32x4|64x2))\.(splat|replace_lane|neg|add|sub)",
    "i(8x16|16x8|32x4)\.(eq|ne|([lg][te]_[su])|abs|any_true|all_true|bitmask|((min|max)_[su]))",
    "f(32x4|64x2)\\.(eq|ne|[lg][te]|abs|sqrt|mul|div|min|max)",
    "[fi](32x4|64x2)\\.extract_lane",
    "v8x16\\.(shuffle|swizzle)",
    "i16x8\\.(load8x8_[su]|narrow_i32x4_[su]|widen_(low|high)_i8x16_[su]|mul)",
    "i32x4\\.(load16x4_[su]|widen_(low|high)_i16x8_[su]|mul|trunc_sat_f32x4_[su])",
    "i64x2\\.(load32x2_[su]|mul)",
    "(v(8x16|16x8|32x4|64x2)\.load_splat)",
    "i8x16\\.narrow_i16x8_[su]",
