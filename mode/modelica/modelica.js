...
/* modified named function expressions and unused variables to prevent CodeMirror lint failures */
/*
...
terminals_: {2:"error"},
productions_: [0,[3,0]],
performAction: function /*anonymous*/(_yytext, _yyleng, _yylineno, _yy, yystate /* action[1] */, _$$ /* vstack */, _$ /* lstack */) {
/* this == yyval */
...
parse: function /*parse*/(input) {
    ...
    var symbol, preErrorSymbol, state, action, _a, r, yyval = {}, p, len, newState, expected;
    while (true) {
...
options: {},
performAction: function /*anonymous*/(_yy,yy_,$avoiding_name_collisions,_YY_START) {
