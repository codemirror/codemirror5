...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
    ...
    function smartHome()
    {	
      var lineContent = lines[sel.from.line].text;
	  var firstNonWhiteSpaceChar = 0;
      ...
      var newCh = 0;
      if (firstNonWhiteSpaceChar > 0 && firstNonWhiteSpaceChar != sel.from.ch) { newCh = firstNonWhiteSpaceChar; }
      setCursor(sel.from.line, newCh, true);
    }
