...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
    ...
    function markText(from, to, className) {
      ...
      function add(line, from, to, className) {
        mark = getLine(line).addMark(new MarkedText(from, to, className, set));
      }
  ...
  MarkedText.prototype = {
    ...
    copy: function(from, to) { return new MarkedText(from, to, this.style, this.set); }
  };
  function Bookmark(from, to) {
    this.from = from; this.to = to; this.line = null;
  }
  Bookmark.prototype = {
    attach: function(line) { this.line = line; },
    detach: function(line) { if (this.line == line) this.line = null; },
    copy: function(from, to) { return new Bookmark(from, to); }
  };
    ...
    if (mk) {
      for (var i = 0; i < mk.length; ++i) {
        if (mk[i].to == null && mk[i].style) {
          ...
          newmk.push(mark.copy(null, null));
          mark.attach(ln);
        }
      }
    }
      ...
      if (mk) {
        ...
        for (var i = 0, mark = mk[i]; i < mk.length; ++i) {
          if (mark.from != null && mark.from >= from)
            mark.from = Math.max(to, mark.from) + diff;
          if (mark.to != null && mark.to > from)
            mark.to = to < mark.to ? mark.to + diff : (from || 0);
          if (from == null && to > mark.from && (to < mark.to || mark.to == null))
            mark.from = null;
          if (to_ == null && (from < mark.to || mark.to == null) && (from > mark.from || mark.from == null))
            mark.to = null;
          if (mark.from != null && mark.to != null && mark.from >= mark.to) {
            mark.detach(this);
            mk.splice(i--, 1);
          }
        }
      ...
      if (mk) {
        for (var i = 0; i < mk.length; ++i) {
          ...
          if (mark.to > pos || mark.to == null) {
            ...
            var newmark = mark.copy(mark.from < pos || mark.from == null ? null : mark.from - pos + textBefore.length,
                                    mark.to == null ? null : mark.to - pos + textBefore.length);
          ...
          if (!mark.from) {
            for (var j = 0; j < mymk.length; ++j) {
              ...
              if (mymark.to == mylen && mymark.set == mark.set) {
                ...
                if (mymark.from != null && mymark.to != null && mymark.from >= mymark.to) {
                  mymark.detach(this);
                  mk.splice(i--, 1);
                }
                continue outer;
      ...
      for (var i = 0; i < mk.length; ++i) {
        ...
        if (close && omk) {
          for (var j = 0; j < omk.length; ++j)
            if (omk[j].set == mark.set) {close = false; break;}
        }
