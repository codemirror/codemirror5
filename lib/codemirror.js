...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
      ...
      doc.iter(from, to, function(line) {
        ...
        if (!nextIntact || nextIntact.from > j) {
          if (line.hidden) scratch.innerHTML = "<pre></pre>";
            ...
            var open = line.className ? '<pre class="' + line.className + '">': "<pre>";
            scratch.innerHTML = open + line.getHTML(ch1, ch2, tabText) + "</pre>";
          }
    ...
    function charFromX(line, x) {
      ...
      function getX(len) {
        measure.innerHTML = "<pre><span>" + lineObj.getHTML(null, null, tabText, len) + "</span></pre>";
    ...
    function measureLine(line, ch) {
      ...
      measure.innerHTML = "<pre>" + line.getHTML(null, null, tabText, ch) +
  ...
  Line.prototype = {
    ...
    getHTML: function(sfrom, sto, tabText, endAt) {
      var html = [], first = true;
