...
(function(mod) {
  ...
  function measureForScrollbars(cm) {
    if (cm.display.gutters.style.height)
  ...
  function makeChangeFromHistory(doc, type, allowSelectionOnly) {
    ...
    var antiChanges = [];
    pushSelectionToHistory(doc, selAfter, dest);
  ...
  function addChangeToHistory(doc, change, selAfter, opId) {
    ...
    if ((hist.lastOp == opId ||
      ...
      if (!before || !before.ranges)
        pushSelectionToHistory(doc, doc.sel, hist.done);
  ...
  function pushSelectionToHistory(doc, sel, dest) {
    var top = lst(dest);
  ...
  function pushPendingSelection(doc, dest, clearOpposite) {
    ...
    if (hist.pendingSelection) {
      pushSelectionToHistory(doc, hist.pendingSelection, dest);
