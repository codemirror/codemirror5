...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
    ...
    function handleKeyBinding(e) {
      ...
      if (e_modifier(e, "alt")) name = "Alt-" + name;
      if (e_modifier(e, "ctrl")) name = "Ctrl-" + name;
      if (e_modifier(e, "meta")) name = "Cmd-" + name;
      if (e_modifier(e, "shift") &&
    ...
    function onKeyDown(e) {
      ...
      setShift(code == 16 || e_modifier(e, "shift"));
      ...
      if (window.opera) {
        ...
        if (!handled && e.keyCode == 88 && e_modifier(e, mac ? "meta" : "ctrl"))
          replaceSelection("");
      }
    }
  ...
  // Allow 3rd-party code to override modifiers by adding an override
  // object to a key event.
  function e_modifier(e, mod) {
    return e.override ? e.override[mod + "Key"] : e[mod + "Key"];
  }
