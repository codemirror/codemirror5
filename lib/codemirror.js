  ...
  CodeMirror.prototype = {
    ...
    schedulePoll: function(time, keyId) {
      ...
      function pollForKey() {
        ...
        if (state || (!missed && (missed = true))) self.schedulePoll(200, keyId);
    ...
    readInput: function() {
      ...
      var movedLine = rs || from.line != sel.from.line || to.line != sel.to.line;
      if (!movedLine) {ed.start = selstart; ed.end = selend; ed.text = text;}
