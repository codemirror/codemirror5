...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
    ...
    function onMouseDown(e) {
      ...
      // selection.
      if (!start) {if (e_target(e) == scroller) e_stop(e); return;}
    ...
    function onKeyDown(e) {
      ...
      if (code == 33 || code == 34) {scrollPage(code == 34); return e_stop(e);} // page up/down
      if (mod && ((code == 36 || code == 35) || // ctrl-home/end
                  mac && (code == 38 || code == 40))) { // cmd-up/down
        scrollEnd(code == 36 || code == 38); return e_stop(e);
      }
      if (mod && code == 65) {selectAll(); return e_stop(e);} // ctrl-a
      if (!options.readOnly) {
        if (!anyMod && code == 13) {return;} // enter
        if (!anyMod && code == 9 && handleTab(e.shiftKey)) return e_stop(e); // tab
        if (mod && code == 90) {undo(); return e_stop(e);} // ctrl-z
        if (mod && ((e.shiftKey && code == 90) || code == 89)) {redo(); return e_stop(e);} // ctrl-shift-z, ctrl-y
      }
    ...
    function onKeyPress(e) {
      ...
      if (code == 13) {if (!options.readOnly) handleEnter(); e_stop(e);}
      else if (!e.ctrlKey && !e.altKey && !e.metaKey && code == 9 && options.tabMode != "default") e_stop(e);
  ...
  function e_stop(e) {stopEvent.call(e);}
