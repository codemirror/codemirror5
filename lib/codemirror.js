  ...
  function CodeMirror(place, givenOptions) {
    ...
    function cloneWheelEvent(e, deltaX, deltaY) {
      ...
      if (e.type === "DOMMouseScroll") {
        // Firefox
        clone = document.createEvent("MouseScrollEvents");
        clone.initMouseScrollEvent(e.type, e.bubbles, e.cancelable, e.view, e.detail,
          e.screenX, e.screenY, 5, e.clientY,
          e.ctrlKey, e.altKey, e.shiftKey, e.metaKey,
          e.button, e.relatedTarget, e.axis);
      }
      else {
        // WebKit or standard
        clone = document.createEvent("WheelEvent");
    ...
    var handlingMouseWheel = false;
    function onMouseWheel(e) {
      // Avoid recursive calls in the case where we're redispatching a horizontal scroll event
      // to the scroller.
      if (handlingMouseWheel) {
        return;
      }
      handlingMouseWheel = true;
      ...
      // vertical component).
      e_stop(e);
      if (e.deltaY || e.wheelDeltaY || (e.axis === e.VERTICAL_AXIS)) {
        scrollbar.dispatchEvent(cloneWheelEvent(e, 0, e.deltaY || e.wheelDeltaY));
      }
      if (e.deltaX || e.wheelDeltaX || (e.axis === e.HORIZONTAL_AXIS)) {
        scroller.dispatchEvent(cloneWheelEvent(e, e.deltaX || e.wheelDeltaX, 0));
      }
