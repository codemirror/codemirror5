...
(function(mod) {
  ...
  CodeMirror.prototype = {
    ...
    getTokenAt: function(pos, precise) {
      var doc = this.doc;
      pos = clipPos(doc, pos);
      var state = getStateBefore(this, pos.line, precise), mode = doc.mode;
    ...
    getLineTokens: function(line, precise) {
      var doc = this.doc;
      line = clipPos(doc, {line: line}).line;
      var state = getStateBefore(this, line, precise), mode = doc.mode;
      var line = getLine(doc, line);
      var stream = new StringStream(line.text, this.options.tabSize);
      var tokens = [], style;
      while(!stream.eol()) {
        stream.start = stream.pos;
        style = readToken(mode, stream, state);
        tokens.push({start: stream.start, end: stream.pos, string: stream.current(), type: style || null, state: copyState(mode, state)});
      }
      return tokens;
    },
