...
//    inputDiv.style.width = "30em"; inputDiv.style.height = "5em"; input.rows = 3;
    ...
    function updateGutter() {
      ...
      for (var i = showingFrom; i < showingTo; ++i) {
        ...
        if (marker && marker.text)
          text = marker.text + (marker.leaveNumber && text != null ? text : "");
        else if (text == null)
          text = "\u00a0";
    ...
    function addGutterMarker(line, text, className, leaveNumber) {
      if (typeof line == "number") line = lines[clipLine(line)];
      line.gutterMarker = {text: text, style: className, leaveNumber: leaveNumber};
      updateGutter();
      return line;
    }
