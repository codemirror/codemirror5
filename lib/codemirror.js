...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
    ...
    // This variable allows a command to override the default hehavior of scrolling to the cursor position
    // after a select change. endOperation() examines this variable to determine if the scroll position 
    // should be updated. startOperation() sets this to false (the default). To change the the default
    // set the variable to true after a call to startOperation()
    ...
    var instance = wrapper.CodeMirror = {
      ...
      setSelection: operation(function(from, to, user, preserveScrollPos) {
        preserveScrollPosOnSelChange = preserveScrollPos;
