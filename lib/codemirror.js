...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
        ...
        '<div style="position: relative">' + // Set to the height of the text, causes scrolling
          '<div style="position: relative">' + // Moved around its parent to cover visible view
            ...
            '<div class="CodeMirror-lines"><div style="position: relative" draggable="true">' +
              '<div style="position: absolute; height: 0; overflow: hidden; visibility: hidden"></div>' +
    ...
    var placeHolder = '<span id="CodeMirror-temp"></span>';
    // Work around IE quircks mode weirdness
    measure.innerHTML = "abc" + placeHolder;
    if (document.getElementById("CodeMirror-temp").offsetLeft == 0)
      placeHolder = '<img style="width: 0" id="CodeMirror-temp">';
    function measureLine(line, ch) {
      ...
      measure.innerHTML = "<pre>" + line.getHTML(null, null, false, ch) +
        placeHolder + line.text.slice(ch, ch + 30) + "</pre>";
