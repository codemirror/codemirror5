...
window.CodeMirror = (function() {
  ...
  CodeMirror.prototype = {
    ...
    getUserVisibleLines: function() {
      var scrollInfo = this.getScrollInfo();
      var oneDivTextHeight = 1 / this.defaultTextHeight();
      var occludeTorleranceTop = 0.1;
      var occludeTorleranceBottom = 0.6;
      var rounding = Math.round;
      return {
        // The top line of the current editor window
        from: rounding(scrollInfo.top * oneDivTextHeight - occludeTorleranceTop),
        // The bottom line of the current editor window
        to: rounding((scrollInfo.top + scrollInfo.clientHeight) * oneDivTextHeight - occludeTorleranceBottom) - 1
      };
    },
