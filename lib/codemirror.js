...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
      ...
      doc.iter(from, to, function(line) {
        ...
        if (!nextIntact || nextIntact.from > j) {
          if (line.hidden) var lineElement = document.createElement("pre");
            ...
            if (line.bgClassName) {
              var div = createElement("div", null, null, null, "position: relative");
              var pre = createChild(div, "pre", "\u00a0", null, line.bgClassName, "position: absolute; left: 0; right: 0; top: 0; bottom: 0; z-index: -2");
      ...
      doc.iter(showingFrom, Math.max(showingTo, showingFrom + 1), function(line) {
        if (line.hidden) {
          ...
          if (marker && marker.text)
            html = marker.text.replace("%N%", text != null ? text : "");
          else if (text == null)
            text = "\u00a0";
          var markerElement = createChild(fragment, "pre", text, html, marker && marker.style);
    ...
    function makeTab(col) {
      ...
      var span = createElement("span", str, null, "cm-tab");
  ...
  var firefox_lt8 = /Firefox\/[1-7]/i.test(navigator.userAgent);
        ...
        if (!specials.test(text)) {
          ...
          while (true) {
            ...
            if (m[0] == "\t") {
              ...
              var token = createElement("span", "\u2022", null, "cm-invalidchar");
  ...
  function createElement(tag, text, html, className, style) {
    var e = document.createElement(tag);
    if (className) e.className = className;
    if (style) e.style.cssText = style;
    if (text) setTextContent(e, text);
    if (html) setHTMLContent(e, html);
    return e;
  }
  function createChild(parent, tag, text, html, className, style) {
    var e = createElement(tag, text, html, className, style);
