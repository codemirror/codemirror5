...
(function(mod) {
  ...
  CodeMirror.prototype = {
    ...
    getTokensOfLine: function(line, precise) {
      var doc = this.doc;
      line = clipPos(doc, {line: line}).line;
      var state = getStateBefore(this, line, precise), mode = this.doc.mode;
      ...
      while(!stream.eol()) {
        ...
        tokens.push({start: stream.start, end: stream.pos, string: stream.current(), type: style || null, state: state});
      }
      return tokens;
    },
