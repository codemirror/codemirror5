var CodeMirror = (function() {
  ...
  function CodeMirror(place, options) {
    ...
    div.innerHTML = '<textarea style="position: absolute; width: 10000px; left: -100000px; top: -100000px;"></textarea>' +
      ...
      '<div style="position: relative"><div><div class="CodeMirror-gutter"></div>' +
    ...
    var input = div.firstChild, code = div.lastChild, 
        space = code.firstChild, mover = space.firstChild, gutter = mover.firstChild,
        measure = mover.lastChild.firstChild, cursor = measure.nextSibling, lineDiv = cursor.nextSibling;
...
//      showingTo = updateLine(showingTo);
    ...
    function refreshDisplay(from, to) {
      ...
      mover.style.top = gutter.style.top = (from * lineHeight()) + "px";
      updateGutter();
    }
    function patchDisplay(updates, from, to) {
      ...
      for (var i = 0, e = updates.length; i < e; ++i) {
        ...
        if (extra) {
          var nodeAfter = lineDiv.childNodes[rec.at + off + rec.size]; 
      ...
      showingFrom = from; showingTo = to;
      lineDiv.style.top = gutter.style.top = (from * lineHeight()) + "px";
      if (off) updateGutter();
    }
    ...
    function updateCursor() {
      if (posEq(sel.from, sel.to)) {
        cursor.style.top = (sel.from.line - showingFrom) * lineHeight() + "px";
