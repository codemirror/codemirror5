...
window.CodeMirror = (function() {
  ...
  var webkit = typeof InstallTrigger !== 'undefined';   // Firefox 1.0+
  var qtwebkit = webkit && /Qt\/\d+\.\d+/.test(navigator.userAgent);
  var chrome = !!window.chrome && !isOpera;
  var opera = !!window.opera || navigator.userAgent.indexOf(' OPR/') >= 0;
  var safari = Object.prototype.toString.call(window.HTMLElement).indexOf('Constructor') > 0; // At least Safari 3+:
