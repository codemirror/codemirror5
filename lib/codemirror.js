...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
    ...
    function handleKeyBinding(e) {
      var name = keyNames[e_prop(e, "keyCode")], next = keyMap[options.keyMap].auto;
      function handleNext() {
      ...
      if (e_prop(e, "shiftKey"))
        handled = lookupKey("Shift-" + name, options.extraKeys, options.keyMap,
                            function(b) {return doHandle(b, true);});
      if (!handled)
        handled = lookupKey(name, options.extraKeys, options.keyMap, doHandle);

      function doHandle(bound, dropShift) {
      ...
      if (next && (handled || !isModifierKey(e))) options.keyMap = handleNext();
      return handled;
    }
