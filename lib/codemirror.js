...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
        ...
        '<div style="position: relative">' + // Set to the height of the text, causes scrolling
          '<div style="position: relative">' + // Moved around its parent to cover visible view
            ...
            '<div class="CodeMirror-lines"><div style="position: relative">' +
              ...
              '<div></div><div></div>' + // DIVs containing the selection and the actual code
            '</div></div></div></div></div>';
    ...
    function onKeyUp(e) {
      if (options.onKeyEvent && options.onKeyEvent(instance, addStop(e))) return;
      if (e_prop(e, "keyCode")) shiftSelecting = null;
    }
    ...
    function patchDisplay(from, to, intact) {
      ...
      doc.iter(from, to, function(line) {
        ...
        if (!nextIntact || nextIntact.from > j) {
          ...
          else scratch.innerHTML = (line.className ? '<pre class="' + line.className + '">' : "<pre>") +
            line.getHTML(tabText) + "</pre>";
    ...
    function updateSelection() {
      ...
      if (collapsed) {
        ...
        function add(left, top, right, height) {
          html += '<pre class="CodeMirror-selected" style="position: absolute; left: ' + left +
            'px; top: ' + top + 'px; right: ' + right + 'px; height: ' + height + 'px; z-index: -1"></pre>';
        }
  ...
  function e_prop(e, prop) {
    return e.override ? e.override[prop] : e[prop];
  }
