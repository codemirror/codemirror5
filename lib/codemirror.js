...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
    ...
    function scrollInlineWidgetIntoView(widget) {
      ...
      // of th editor that contains it.
      var heightForScroll = Math.min(inlineTop + widget.height, scroller.clientHeight);
      scrollIntoView(scroller.scrollLeft, inlineTop, scroller.scrollLeft, heightForScroll);
    }
