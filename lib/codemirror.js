...
window.CodeMirror = (function() {
  ...
  CodeMirror.fromTextArea = function(textarea, options) {
    ...
    /* If no id was provided use textarea id */ 
    if(!options.id && textarea.id) options.id = textarea.id
  ...
  /* returns instance by id or all */  
  function getInstance(instanceId) {
    if(typeof instanceId === 'string') {
      for(var l = instances.length; l > 0; l--) {
        if(instances[l-1].id === instanceId)
          return instances[l-1]; 
      }
      return null;  
    }  
    return instances;    
  }
  CodeMirror.getInstance = getInstance;
