...
<div class="CodeMirror-code"><div style="position: absolute; visibility: hidden"><span>-</span></div>\
<div style="position: relative"><span class="CodeMirror-cursor"> </span><div style="position: absolute; left: 0;"></div></div></div>';
    ...
    function updateCursor() {
      if (posEq(sel.from, sel.to)) {
        ...
        cursor.style.left = charX(sel.from.line, sel.from.ch) + "px";
    ...
    function posFromMouse(e) {
      ...
      return clipPos({line: line, ch: charFromX(line, x)});
    }
