...
//    te.style.left = te.style.top = "-100000px";
    ...
    connect(te, "mouseup", function(){self.readInput();});
    // TODO polling timer
  ...
  CodeMirror.prototype = {
    ...
    onKeyDown: function(e) {
      ...
      if (code == 33 || code == 34) { // page up/down
        ...
        var self = this, missed = false, id = (ctrl ? "c" : "") + code;
        ...
        function poll() {
          ...
          if (state == "moved") movementKeys[id] = true;
          if (state || (!missed && (missed = true))) schedule(200);
        }
        function schedule(ms) {clearTimeout(self.keydownPoll); self.keydownPoll = setTimeout(poll, ms);}
        schedule(20);
      }
    },
    onKeyUp: function(e) {
