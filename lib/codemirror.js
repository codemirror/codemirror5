...
(function(mod) {
  ...
  CodeMirror.fromTextArea = function(textarea, options) {
    if (!options) options = {};
    if (!options.value) options.value = textarea.value; //Allow the value to be supplied overriding the textarea value;
    ...
    function save() {
      ...
      //Allow for override of the value assigned back to the textarea
      if (hasHandler(cm,"beforeSave")) {
        value = filterSave(value);
        if (!value) return;		
      }
