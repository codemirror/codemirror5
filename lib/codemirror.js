...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
    ...
    var instance = {
      ...
      clearAllMarkers: removeAllGutterMarkers,
      ...
      // getSyntaxErrors returns the errors according to the state of each line
      // must define a function for checkStateError
      getSyntaxErrors: function() {
        var errorLines = [];
        if(options['checkStateError']) {
            for(var i = 0; i < lines.length; i++) {
                if(lines[i].stateAfter && options['checkStateError'](lines[i].stateAfter)) {
                    errorLines.push({
                        line: i
                    });
                }
    ...
    function removeAllGutterMarkers() {
        for(var i = 0; i < lines.length; i++) lines[clipLine(i)].gutterMarker = null;
        updateGutter();
    }
