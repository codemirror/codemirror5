...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
    ...
    if (options.dragDrop) {
      ...
      connect(scroller, "dragover", onDragOver);
      connect(scroller, "dragleave", onDragLeave);
    ...
    function onDrop(e) {
      ...
      if (files && files.length && window.FileReader && window.File) {
        function loadFile(file, i) {
	      	if( file.type.match(/text/gi) == null ){
      		  var end = replaceRange(file.name, pos, pos);
    ...
    function onDragOver(e){
		...
		var headPos = localCoords(pos, true), th = textHeight();
    ...
    function onDragLeave(e){
    	if( e.target.className == 'CodeMirror-lines' || e.target.className == 'CodeMirror-gutter-text' ){
