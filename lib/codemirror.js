...
*/
    ...
    function moveV(dir, unit) {
      ...
      // TODO: this probably won't work if there's an inline widget
      ...
      for (var i = 0; i < inlines.length; i++) {
        ...
        if (inline.exists()) {
          ...
          if (lastInlineY > y) {
            ...
            // TODO: this heuristic is too simple--breaks things like arrow down, drag select
            y = lastInlineY;
            break;
          }
  ...
  function InlineWidget(id, bookmark, node, styleSheet) {
    ...
    var newIndex = styleSheet.insertRule('.' + this.getInlineWidgetClass() + '{}');
