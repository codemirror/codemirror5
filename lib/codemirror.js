...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
        ...
        if (!nextIntact || nextIntact.from > j) {
          if (line.hidden) var lineElement = document.createElement("pre");
            ...
            if (line.bgClassName) {
              ...
              var pre = createElement("pre", "\u00A0", line.bgClassName, "position: absolute; left: 0; right: 0; top: 0; bottom: 0; z-index: -2");
              div.appendChild(pre);
    ...
    function measureLine(line, ch) {
      ...
      measure.innerHTML = "";
      var pre = line.getElement(makeTab, ch, tempId, wbr);
  ...
  Line.prototype = {
    ...
    getElement: function(makeTab, wrapAt, wrapId, wrapWBR) {
