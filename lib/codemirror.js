...
//    inputDiv.style.width = "30em"; inputDiv.style.height = "5em"; input.rows = 3;
    ...
    function onKeyDown(e) {
      ...
      var mod = !mac || window.opera ? e.e.ctrlKey : (e.e.ctrlKey && e.e.altKey) || e.e.metaKey;
      ...
      if (code == 33 || code == 34) {scrollPage(code == 34); done = true;} // page up/down
        ...
        if (!mod && code == 13) {handleEnter(); done = true;} // enter
        else if (!mod && code == 9) {if (handleTab(e.e.shiftKey)) done = true;} // tab
