...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
    ...
    function updateCursor() {
      ...
      inputDiv.style.top = (head.line * lh - scroller.scrollTop + (ie ? scroller.offsetTop : 0)) + "px";
      inputDiv.style.left = (head.ch * cw - scroller.scrollLeft + (ie ? scroller.offsetLeft : 0)) + "px";
