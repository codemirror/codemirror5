...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, options) {
    ...
    var self = this;
    connect(div, "mousedown", this.operation("onMouseDown"));
    ...
    connect(div, "drop", this.operation("onDrop"));
  ...
  CodeMirror.prototype = {
    ...
    displaySelection: function() {
      ...
      var ypos = lineElt(this.lines[(sel.inverted ? sel.from : sel.to).line]).offsetTop, line = this.lineHeight(),
    ...
    endOperation: function() {
      ...
      if (ps.from.line != sel.from.line || ps.to.line != sel.to.line || this.linesShifted)
        this.prepareInput();
    },
