...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
    ...
    var instance = wrapper.CodeMirror = {
      ...
      getLineRangeHeight: function(lineFrom, lineTo) {
        return textHeight() * (heightAtLine(doc, lineTo) - heightAtLine(doc, lineFrom));
      },
    ...
    function onMouseDown(e) {
      ...
      for (var n = e_target(e); n != wrapper; n = n.parentNode)
        if ((n.parentNode == code && n != mover) || n.getAttribute(inlineAttr)) return;
    ...
    function onDoubleClick(e) {
      for (var n = e_target(e); n != wrapper; n = n.parentNode) {
        ...
        else if (n.getAttribute(inlineAttr)) return;
      }
      var start = posFromMouse(e);
      if (!start) return;
