...
// TODO: vertical mousewheel/touch scrolling doesn't work--need to catch mousewheel events and fake scroll
// TODO: paging up/down in browser appears to be handled by browser as well as CodeMirror--not sure why the
//       preventDefault isn't working for this (we currently hack scroller.scrollTop to 0 to work around this,
//       but need to identify the root cause)
// TODO: paging down is flickery
// TODO: current way of laying out scrollbar might break existing CodeMirror users, because
...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
    ...
    function updateVerticalScroll() {
      ...
      // TODO: Page up/page down seem to be getting handled by the browser even though we
      // preventDefault(). For now, we explicitly force scrollTop for the scroller back to 0 
      // to deal with this. We need to track down the underlying problem though.
