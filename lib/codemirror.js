...
//    te.style.left = te.style.top = "-100000px";
  ...
  CodeMirror.prototype = {
    ...
    onMouseDown: function(e) {
      ...
      // TODO don't update the textarea when moving?
    ...
    readInput: function() {
      var ed = this.editing, changed = false, sel = this.selection;
      ...
      if (from.line != sel.from.line || to.line != sel.to.line)
        changed = true;
      else if (from.ch != sel.from.ch || to.ch != sel.to.ch)
        changed = "sel";
