...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
    ...
    function findPosH(dir, unit, position) {
      ...
      function charType() {
        ...
        for (var i = 0; i < unit.length; ++i) if (unit[i].test(c)) return i;
      }
      if (unit == "char") moveOnce();
        ...
        while (moveOnce()) {
          var thisCharType = charType();
          if (thisCharType != prevCharType) {
            if (thisCharType != null && position == "start") break;
            else if (prevCharType != null) {
  ...
  var commands = CodeMirror.commands = {
    ...
    goWordLeft: function(cm) {cm.moveH(-1, cm.getOption("wordChars"), "end");},
    goWordRight: function(cm) {cm.moveH(1, cm.getOption("wordChars"), "after");},
