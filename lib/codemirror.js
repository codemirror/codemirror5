...
window.CodeMirror = (function() {
  ...
  function measureLine(cm, line, ch) {
    var data = lineMeasurements(cm, line), dir = -1, len = line.text.length;
  ...
  function lineMeasurements(cm, line) {
    ...
    var measure = lineMeasurementsInner(cm, line);
  ...
  function lineMeasurementsInner(cm, line) {
  ...
  function endOperation(cm) {
    ...
    if (view.maxLineChanged && !cm.options.lineWrapping) {
      var width = measureLine(cm, view.maxLine, view.maxLine.text.length).right;
