...
(function(){
 ...
 CodeMirror.connect(window, "mousedown", function(e){console.log('down'); e.preventDefault(); e.stopPropagation();});
     CodeMirror.connect(window, "mousemove", function(e){console.log('move'); e.preventDefault(); e.stopPropagation();});
     CodeMirror.connect(window, "mouseup", function(e){console.log('up'); e.preventDefault(); e.stopPropagation();});
                                                     
     input.onfocus = function(e){
       var yScroll = window.pageYOffset, xScroll = window.pageXOffset;
       window.setTimeout(function(){console.log('after'+window.pageYOffset)},100);
       console.log('before'+window.pageYOffset);
       window.setTimeout(function(){window.scrollTo(xScroll,yScroll);},0);
     }
