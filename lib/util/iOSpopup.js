  ...
  function iOSpopup(cm) {
     ...
     function updateSelection(mode){
       return function(e){
           ...
           var adjustY  = (mode!=="end")? startSel.firstChild.offsetHeight : -endSel.firstChild.offsetHeight,
               coords   = {x: e.touches[0].pageX, y: e.touches[0].pageY+(mode==="middle"? 0 : adjustY)},
           ...
           if(mode==="middle" || startPos.line < endPos.line || (startPos.line===endPos.line && startPos.ch<endPos.ch)){
              ...
              // generate magnifier at the right place, either as a cursor or selection shape
               magnifyingGlass.className = "magnifying "+(mode==="middle"? "cursor" : "selection");
    ...
    function selectHandler(){
     ...
     function magnifyCursor(e){
       ...
       var unregister = CodeMirror.connect(scroller, "touchmove", updateSelection("middle"), true);
                                                     
       // when the finger is lifted, hide the magnifier and cleanuo
       CodeMirror.connect(scroller, "touchend", function(e){updateSelection("middle")(e); unregister();});
       updateSelection("middle")(e);
     }
