    ...
    if(!(navigator.userAgent.match(/iPod/i) ||
     ...
     function drawTool(e){
        ...
        function drawMagnifier(e){
           ...
           tool.style.left = e.pageX - tool.offsetWidth/2 + "px";
           tool.style.top  = e.pageY - tool.offsetHeight  + "px";
           magnifiedStuff.style.top  = (-e.pageY+wrapper.offsetTop+magnifier.offsetHeight/6)*magnifiedScale+"px";
           magnifiedStuff.style.left = (-e.pageX+gutterWidth-scrollInfo.x-15)*magnifiedScale+magnifier.offsetWidth/2+"px";
