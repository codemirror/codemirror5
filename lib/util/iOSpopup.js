  ...
  function iOSpopup(cm) {
    if(!(navigator.userAgent.match(/iPod/i) ||
     ...
     function updateCursors(mode){
       return function(e){
           ...
           if(mode==="both" || startPos.line<endPos.line || (startPos.line===endPos.line && startPos.ch<endPos.ch)){               cm.setSelection(startPos, endPos);
    ...
    *    Connect Event Handlers                                                           */
     ...
     function moveOrEndHandler(e){
       ...
       if(LAST_TOUCH && LAST_TOUCH.type === "touchstart" && e.type === "touchend"){
