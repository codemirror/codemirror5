...
//        hoverElt.innerHTML = null;
        ...
        hoverElt.className ='aboveEdge';
        if((startCursor.y - (hoverElt.offsetHeight+10)) > scrollInfo.y){
        ...
        var triangleLeft = Math.min(Math.max(15, popupX-hoverElt.offsetLeft), hoverElt.offsetWidth-20)-hoverElt.offsetWidth;
        ...
        triangleStyle.appendChild(document.createTextNode('#hoverElt:after{left: '+triangleLeft+'px;'));
     ...
     function updateCursors(mode){
       return function(e){
           ...
           hoverElt.style.display = (e.type === 'touchend')? "block" : "none";
    ...
    *    Connect Event Handlers                                                           */
     ...
     function moveOrEndHandler(e){
       ...
       function onTap(e){
         hoverElt.style.display=startSel.style.display=endSel.style.display='none';
    ...
    function startHandler(e){
     ...
     cm.setOption("onChange", function(e){hoverElt.style.display="none"; drawPopup(e);});
  }
