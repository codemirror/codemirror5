  ...
  function iOSpopup(cm) {
    ...
    // TOOL NODES
     var selectAll= elt('li', "Select All"),
         ...
         copy     = elt('li', "Copy"),
         cut      = elt('li', "Cut"),
         startSel = elt('span',[elt('span')],null,'selectionDotTouchTarget'),
         endSel   = elt('span',[elt('span')],null,'selectionDotTouchTarget'),
         popup    = elt('ul',null,'iOSpopup'),
         magnifiedStuff = elt('div',null,null,'magnifiedStuff'),
         magnifier= elt('div',[magnifiedStuff],'magnifier'),
         notch    = elt('b',null,'notch'),
     ...
     // Make sure there's only one set of nodes on the page
