  ...
  function iOSpopup(cm) {
    ...
    function selectHandler(){
     ...
     function magnifyCursor(e){
       ...
       var unregisterEnd = CodeMirror.connect(scroller, "touchend", function(e){updateCursors("both")(e);
                                              unregisterMove();
                                              });
    ...
    *    Connect Event Handlers                                                           */
     ...
     function setTimer(e){timer = window.setTimeout(function(){magnifyCursor(e);},500);}
