...
// "use strict";
 ...
 CodeMirror.defineInitHook(function(cm){iOSpopup(cm);});
     ...
     // adapted from http://37signals.com/svn/posts/2407-device-scale-user-interface-elements-in-ios-mobile-safari
     (function() {
      ...
      stylesheet.insertRule("#tool, .selectionDotTouchTarget {-webkit-transform:scale("+(window.innerWidth/deviceWidth)+")}");
      }
      })();