  ...
  function iOSpopup(cm) {
    if(!(navigator.userAgent.match(/iPod/i) ||
     ...
     function updateCursors(mode){
       return function(e){
           ...
           if(e.touches.length !== 1){ drawPopup(e); console.log();return;}
    ...
    function selectHandler(){
     ...
     function magnifyCursor(e){
       ...
       magnifiedCM = CodeMirror.fromTextArea(magnifiedCM,{lineNumbers: cm.getOption("lineNumbers")});
    ...
    *    Connect Event Handlers                                                           */
     ...
     CodeMirror.connect(scroller,   "click",      function(e){popupVisible=false; setTimeout(drawPopup, 500);});
