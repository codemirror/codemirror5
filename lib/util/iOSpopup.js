  ...
  function iOSpopup(cm) {
    if(!(navigator.userAgent.match(/iPod/i) ||
     ...
     function drawPopup(e){
        ...
        // make sure the popup is never out of bounds, and position the triangle as close to cursor as possible
        ...
        trianglePos = 'left: '+Math.min(Math.max(15, popupX-popup.offsetLeft), popup.offsetWidth-20) + 'px';
 
        var css = '#iOSpopup  li:last-child:after{ ' + trianglePos+'; }';
