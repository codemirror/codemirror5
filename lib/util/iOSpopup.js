     ...
     function updateSelection(startChanging){
       return function(e){
           ...
           if(startPos.line < endPos.line || (startPos.line===endPos.line && startPos.ch<endPos.ch)){
              ...
              var selOffset = changingSel.offsetHeight/2 + (startChanging? -5 : 50);
              magnifiedStuff.style.top = (-e.touches[0].pageY+wrapper.offsetTop-scrollInfo.y)*magnifiedScale+selOffset+"px";
