...
CodeMirror.defineExtension("getModeExtAtPos", function (pos) {
  ...
  if (token && token.state && (token.state.mode || token.state.base.mode))
    return CodeMirror.modeExtensions[(token.state.mode == "html" || token.state.base.mode == "html") ? "htmlmixed" : (token.state.mode?token.state.mode:token.state.base.mode)];
  else
