...
(function(){
// "use strict";
  function FifthRow(cm, keyConfig) {
     var keysVisible = false,
        iPhone  = (navigator.userAgent.match(/iPhone/i)) || (navigator.userAgent.match(/iPod/i)),
        iPad    = (navigator.userAgent.match(/iPad/i)),
        keySound = {sound: new Audio('lib/util/click.mp3'), play: function(){this.sound.play()}};
  ...
  CodeMirror.defineExtension("addKeyrow", function(keyArray) { return new FifthRow(this, keyArray);});
})();
...
keySound = {source : new Audio('/lib/util/click.aiff'), play: function(){this.source.play()}};
