    ...
    *    Popup Code                                                                       */
    ...
    drawPopup : function(){
      ...
      if(that.popupVisible && !cm.somethingSelected()){
        ...
        popup.style.left = (cm.cursorCoords().x - popup.offsetWidth/2) + "px";
        popup.style.top = cm.cursorCoords().y - (popup.offsetHeight+10) + "px";
      ...
      // since it will steal touch events on endSel due to CM's default behavior.
        ...
        popup.style.top  = firstRect.top + window.pageYOffset - (popup.offsetHeight+20) + "px";
