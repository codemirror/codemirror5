  ...
  TouchSupport.prototype = {
    ...
    *    Popup Code                                                                       */
    ...
    drawPopup : function(){
      ...
      popup.className = '';
      // if the top of the popup is above the viewport's top edge, draw it below the selection
      ...
      if(middle-popup.offsetWidth/2 < scrollInfo.x){
      ...
      } else if(middle+popup.offsetWidth/2+gutterWidth > screen.availWidth+scrollInfo.x-gutterWidth){
    ...
    updateSelection: function(startChanging){
      return function(e){
        ...
        if(startPos.line <= endPos.line && startPos.ch < endPos.ch){
