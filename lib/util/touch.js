    ...
    *    Popup Code                                                                       */
    ...
    drawPopup : function(){
      ...
      // since it will steal touch events on endSel due to CM's default behavior.
        ...
        startSel.style.top = startCursor.y-startSel.offsetWidth/2 + "px";
      ...
      // the top is just the cursor top, minus the height of the popup
      ...
      } else if(middle+popup.offsetWidth/2 > screen.availWidth){
        popup.style.left = screen.availWidth-popup.offsetWidth-cm.getGutterElement().offsetWidth + "px";
